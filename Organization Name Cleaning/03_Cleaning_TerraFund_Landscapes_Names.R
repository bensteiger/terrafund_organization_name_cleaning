...
# Description: Cleaning All landscapes Organization Names in Master Table
...
# Filter to TerraFund Landscapes ----------------------------------------------
...
landscapes_grouped$organization_name_full <- str_replace_all(landscapes_grouped$organization_name_full, "\\(|\\)", "")
...
landscapes_grouped$organization_name_full <- lapply(
  landscapes_grouped$organization_name_full,
  replace_words,
...
landscapes_grouped$organization_name_full <- sapply(landscapes_grouped$organization_name_full, capitalize_first)

# select columns ----------------------------------------------------------

landscapes_grouped_filtered <- landscapes_grouped %>%
...
landscapes_grouped_filtered <- landscapes_grouped_filtered %>%
...
write_csv(landscapes_grouped_filtered,
          file = here(
            "Unified Database",
            "Data",
            "All",
            ...
            "Organization Name Cleaning",
            "Landscapes",
            "landscapes_org_names_02_29_24.csv"
          ))
